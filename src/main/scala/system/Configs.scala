...
class EntanglingIPrefetcherTableSize001Sets2WaysConfig extends EntanglingIPrefetcherConfig(entanglingNSets=1, entanglingNWays=2)
class EntanglingIPrefetcherTableSize001Sets4WaysConfig extends EntanglingIPrefetcherConfig(entanglingNSets=1, entanglingNWays=4)
class EntanglingIPrefetcherTableSize001Sets8WaysConfig extends EntanglingIPrefetcherConfig(entanglingNSets=1, entanglingNWays=8)
